//*****************************************************************************
//Implementing a Queue using 2 stacks(which are in turn based on doubly linked list)
//*****************************************************************************
#include <iostream>
...
public:
	...
	void enqueue(int data) {
		...
		stack2.push(data);//Basically adding values to the queue
	}
